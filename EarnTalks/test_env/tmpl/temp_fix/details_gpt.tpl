...
<tr><td width=170 align="center"><img src='http://capture.heartrails.com/medium?{$listing.url}' width="160" border="0" height="115"></td>
<td valign="top">
...
<tr>
<td align="left" class="list_text">Minimum Spend: <B>{if $listing.min_spend}${$listing.min_spend}{else}Free{/if}</B></td>
...
{/if}
<td colspan=2 align="right" class="list_text" style="color: #666666">Monitored Days: <B>{$listing.monitored}</B><span style="margin-left: 10px">Added: <B>{$listing.added}</B></span></td>
</tr>
</table>
</div>
</td></tr>
