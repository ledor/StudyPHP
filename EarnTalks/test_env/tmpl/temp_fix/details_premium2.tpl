...
<tr><td valign="top">
<table width=100% border=0 cellspacing=0 cellpadding=2>
<tr><td class="list_title"><img src="images/rv.gif" width=13 height=12 align="left"><div class="list_name" align="left"><a href="?a=go&lid={$listing.id}" target="_blank">{$listing.name}</a>{if $listing.new} <img src="images/new_ani.gif" border=0>{/if}</div>
</td></tr>
...
<td class="list_text">Contact Info: {if $listing.support_email}<a href="mailto:{$listing.support_email}"><img alt="Support Email" src="images/smail.gif" align="absMiddle" border=0></a>{/if} </td></tr>
...
{if $listing.support_phone}
<table width=100% border=0 cellspacing=0 cellpadding=0>
<tr><td valign="middle"><div class="maintitle1" align="left"><img src="images/t_pl.png" width=11 height=24 align="left"><div class="maintitle_text" align="left">Our Review about <a href="?a=go&lid={$listing.id}" target="_blank"><font color="white">{$listing.name}</font></a></div></div></td></tr>
