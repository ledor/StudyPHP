...
<br /><p align=left>
The minimum listing fee is ${$settings.normalmonitorfees+$settings.normallistingfees}<font color="#FF0000">(${$settings.normalmonitorfees}+${$settings.normallistingfees})</font> of which <font color="#FF0000">${$settings.normalmonitorfees}</font> will be invested into your program   for monitoring purposes. If your minimum is above our listing fee, please send   minimum investment.<br />
<br />
