...
<br /><p align=left>
The minimum listing fee is ${$settings.trialmonitorfees+$settings.triallistingfees}<font color="#FF0000">(${$settings.trialmonitorfees}+${$settings.triallistingfees})</font> of which <font color="#FF0000">${$settings.trialmonitorfees}</font> will be invested into your program   for monitoring purposes. If your minimum is above our listing fee, please send   minimum investment.<br />
<br />
