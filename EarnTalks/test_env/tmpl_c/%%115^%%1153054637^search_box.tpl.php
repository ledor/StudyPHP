...
<div class="side_title" align="left">Search Programs:</div></td>
...
<tr>
 <td align="center"><input name="content" type="text" class=inpts size="24" />
 <br><input name="submit" type="submit" class=sbmt value="Click to Search" style="width:100px;"/></td>
 </tr>
</form>
</table>
</div></td></tr>
