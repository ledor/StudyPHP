...
<div class="side_title" align="left">E-Currency:</div></td>
...
<tr>
    <td align=left >  
<strong>
<p>Pleas make sure our accounts are as follow, if not please do not made your payment. We are not responsible for any possible maistake from you.<br><font color="FF0000">Our LR account <?php echo $this->_tpl_vars['settings']['admin_lr_account']; ?>
</font> 
</td></tr>
</table>
</div></td></tr>
