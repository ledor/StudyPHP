<?php /* Smarty version 2.6.2, created on 2010-04-09 17:49:27
         compiled from details_premium.tpl */ ?>
<div class="list_side">
...
">Add to Myhyips<?php else: ?><a href="?a=bookmarks&action=delete&lid=<?php echo $this->_tpl_vars['listing']['id']; ?>
" onclick="return confirm('Do you really want to delete this listing?')">Delete<?php endif;  else: ?><a href="javascript:alert('Only available to registered users');">Add to Myhyips<?php endif; ?></a></b> | <b><a href="?a=report_scam&lid=<?php echo $this->_tpl_vars['listing']['id']; ?>
...
<tr><td width=170 align="center"><img src='http://www.shrinktheweb.com/xino.php?embed=1&STWAccessKeyId=4d1f49d5fb9b227&stwsize=lg&stwUrl=<?php echo $this->_tpl_vars['listing']['url']; ?>
 ' width="160" border="0" height="115"></td>
<td valign="top">
...
<td align="left" class="list_text">User Votes: <B><?php echo $this->_tpl_vars['listing']['cvotes']; ?>
 votes</B></td></tr>
<tr><td align="left" class="list_text">Payout Ratio: <B><?php echo $this->_tpl_vars['listing']['ratio']*100; ?>
%  <font color="#ff0000">in profit</font></B></td>
...
<tr>
<td align="left" class="list_text">Minimal Spend: <B><?php if ($this->_tpl_vars['listing']['min_spend']):  echo $this->_tpl_vars['listing']['min_spend'];  else: ?>$0.01<?php endif; ?></B></td>
...
<tr><td align="left" class="list_text">Maximal Spend: <B><?php if ($this->_tpl_vars['listing']['max_spend']):  echo $this->_tpl_vars['listing']['max_spend'];  else: ?>No Limit<?php endif; ?></B></td>
