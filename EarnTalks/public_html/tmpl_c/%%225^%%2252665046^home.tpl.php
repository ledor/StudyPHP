...
<tr><td valign="middle">
<?php if ($this->_tpl_vars['groups'][$this->_sections['g']['index']]['type'] == 'Premium' || $this->_tpl_vars['groups'][$this->_sections['g']['index']]['type'] == 'Scam'): ?>
...
<a href="?a=add&type=<?php echo $this->_tpl_vars['groups'][$this->_sections['g']['index']]['id']; ?>
...
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
  endif;  if ($this->_tpl_vars['groups'][$this->_sections['g']['index']]['type'] == 'GPT'):  $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "list_gpt.tpl", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
