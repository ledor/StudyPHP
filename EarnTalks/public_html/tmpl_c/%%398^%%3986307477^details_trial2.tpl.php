<?php /* Smarty version 2.6.2, created on 2011-12-30 07:59:23
         compiled from details_trial2.tpl */ ?>
...
<tr><td align="center"><img src='http://capture.heartrails.com/medium?<?php echo $this->_tpl_vars['listing']['url']; ?>
...
"><img alt="Support Email" src="images/smail.gif" align="absMiddle" border=0></a><?php endif; ?> <?php if ($this->_tpl_vars['listing']['support_phone']): ?><img alt="Phone: Tel.: <?php echo $this->_tpl_vars['listing']['support_phone']; ?>
" title="Phone: Tel.: <?php echo $this->_tpl_vars['listing']['support_phone']; ?>
" src="images/sphone.gif" align="absmiddle"><?php endif; ?></td></tr>
