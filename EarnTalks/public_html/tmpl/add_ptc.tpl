...
<br /><p align=left>
The minimal deposit is ${$settings.ptcmonitorfees+$settings.ptclistingfees}<font color="#FF0000">(${$settings.ptcmonitorfees}+${$settings.ptclistingfees})</font> of which <font color="#FF0000">${$settings.ptcmonitorfees}</font> will be invested into your program   for monitoring purposes. If your minimum is above our listing fee, please send   minimum investment.<br />
<br />
