  ...
  <tr>  
  <td class=gamesdark>
   <table cellspacing=0 cellpadding=0 border=0 class=gameslite width=100%>
     <tr valign="middle">
       <td width="10"><img src="images/q.gif" width="10"></td>
       <td width="33%" height="25"><a href="?a=go&lid={$listing.id}" target=_blank><b>{$listing.name}</b></a>{if $listing.new} <img src="images/new_ani.gif" border=0>{/if}</td>
       <td width="33%">Status: {if $listing.hyip_status == 1}<font color="#009900"><strong>Paying</strong></font>{/if} {if $listing.hyip_status == 2}<font color="#666666"><strong>Waiting</strong></font>{/if} {if $listing.hyip_status == 3}<font color="#FF6600"><strong>Problem</strong></font>{/if} {if $listing.hyip_status == 4}<font color="#FF0000"><strong>Not Paying</strong></font>{/if}</td>
       <td width="33%" align="right"><b>Added:{$listing.added}</b></td>
       <td width="10"><img src="images/q.gif" width="10"></td>
     </tr>
     <tr valign="top">
       <td width="10" valign="middle" class="grey">&nbsp;</td>
       <td valign="middle" class="grey">Our Rating: {section name=r loop=$listing.rates}{if $listing.rates[r].star}<img src="images/full_star.gif" align=absmiddle>{else}<img src="images/empty_star.gif" align=absmiddle>{/if}{/section}</td>
    ...
    {/if}{else}Our Investment:<b> No Investment</b>     {/if} </td>
       <td>    Minimal Spend: <b>{$listing.min_spend}</b><br>
    ...
    <tr align="center" valign="middle">
      ...
      <td height="20" align="right" valign=middle >Join <a href="?a=go&lid={$listing.id}" target=_blank><b>{$listing.name}</b></a></td>
      <td width="10" valign=top >&nbsp;</td>
	  </tr>{if $listing.description}
	  <tr>
	    <td valign=top class="grey">&nbsp;</td>
	    <td height="0" colspan="3" valign=top class="grey"><strong>Program Discription:</strong><br>
