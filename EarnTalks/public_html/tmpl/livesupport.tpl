...
<tr>
<td align="center">
<br><a href="ymsgr:sendim?{$settings.admin_ym_account}" target="_blank"><img src="http://opi.yahoo.com/online?u={$settings.admin_ym_account}&m=g&t=14" alt="YM" border="0" /></a>
   <br><br>
</table>
</div></td></tr>
</table>
