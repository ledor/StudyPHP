...
<br /><p align=left>
The minimal deposit is ${$settings.gptmonitorfees+$settings.gptlistingfees}<font color="#FF0000">(${$settings.gptmonitorfees}+${$settings.gptlistingfees})</font> of which <font color="#FF0000">${$settings.gptmonitorfees}</font> will be invested into your program   for monitoring purposes. If your minimum is above our listing fee, please send   minimum investment.<br />
<br />
...
<tr align=left>
 <td>Plans:</td><td><input type="text" name="percents" value="{$frm.percents|escape:html}" class=inpts size=50></td>
</tr>
<tr align=left>
