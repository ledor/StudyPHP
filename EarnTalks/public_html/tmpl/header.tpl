...
<title>{$settings.site_name} - Hyip &amp; Autosurf/PTC Monitor,Hyip &amp; Autosurf/PTC Listing Site .</title>
<link href="style.css" rel="stylesheet" type="text/css">
<LINK rel=stylesheet type=text/css href="rte_css.css">
<STYLE type=text/css media=all>@import url(css_18.css);
</STYLE>
{include file="floating_toolbar.tpl"}
{literal}
<script type="text/javascript">

  var _gaq = _gaq || [];
  _gaq.push(['_setAccount', 'UA-18097022-8']);
...
{if showtoprotatingbanners()}{/if}</div>
...
<tr><td height="30" colspan="2" align="center"><p><a href="?a=advertise"><b>Add Program</b></a> | <a href="?a=home"><b>All Programs</b></a> | <a href="?a=new"><b>New Programs</b></a> | 
{section name=g loop=$groups_nav}
 <a href="?type={$groups_nav[g].id}"><b>{$groups_nav[g].nav_name}</b></a> | 
{/section}
<a href="?a=guide"><b>&#9733;Guide for Newbies&#9733;</b></a>
</p></td></tr>

<tr><td colspan="2"><div align="center" class="top_banner">
{if showspecialbanners()}{/if}
</div></td></tr>
